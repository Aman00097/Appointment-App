...
const About = () => {
    return (
        <Box padding='50px 20px'>
            ...
            <Link to={'https://aman00097.github.io/Appointment-App/'} target='_blank'>  <Typography variant='h5' sx={{ textAlign: 'center', mt: '10px', cursor: 'pointer', color: '#7575ff' }}>Source Code</Typography></Link>
        </Box>
    )
}
